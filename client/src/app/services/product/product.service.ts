...
export class ProductService {
  ...
  fetchProducts(): Observable<any> {
    ...
    return this.httpClient.get<any>(this.productUrl, { headers: header }).pipe(
  ...
  saveProduct(payload: Product): Observable<any> {
    ...
    return this.httpClient
      .put<any>(`http://127.0.0.1:4100/api/v1/item/${payload.id}`, payload, {
        headers: header,
      })
      .pipe(
        catchError((error: any) => {
  ...
  createProduct(payload: Product): Observable<any> {
    ...
    return this.httpClient
      .post<any>(`http://127.0.0.1:4100/api/v1/item/`, payload, {
        headers: header,
      })
      .pipe(
        catchError((error: any) => {
  ...
  removeProduct(id: Number): Observable<any> {
    ...
    return this.httpClient
      .delete<any>(`http://127.0.0.1:4100/api/v1/item/${id}?shop_id=1`, {
        headers: header,
      })
      .pipe(
        catchError((error: any) => {
